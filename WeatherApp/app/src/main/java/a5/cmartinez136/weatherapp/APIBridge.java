package a5.cmartinez136.weatherapp;
...
public class APIBridge {
    private String apiKey, geocodingURL, weatherURL, weatherIcon;
    ...
    public APIBridge(UIBind uiBind, Context context ){
        ...
        try{
            ...
            this.weatherIcon = jsonObject.getString(weatherIcon);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response){
                        try{
                            ...
                            weatherModel.setWeatherIcon(String.format(weatherIcon, weather.getString("icon")));
